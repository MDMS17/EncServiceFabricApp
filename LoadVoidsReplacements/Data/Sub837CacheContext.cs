...
namespace LoadVoidsReplacements.Data
{
    public class Sub837CacheContext : DbContext
    {
        public Sub837CacheContext(DbContextOptions<Sub837CacheContext> options)
                  : base(options)
        {
        ...
        {
            modelBuilder.HasDefaultSchema("Subcache");
