...
namespace Load837Recon.Data
{
    public class ReconContext : DbContext
    {
        ...
        {
            modelBuilder.HasDefaultSchema("Recon");
            ...
            modelBuilder.Entity<ResponseError>().ToTable("ResponseError");
            modelBuilder.Entity<LoadLog>().ToTable("LoadLog");
        }
        ...
        public virtual DbSet<ResponseError> ResponseErrors { get; set; }
