...
{
    public class Sub837ErrorContext : DbContext
    {
        public Sub837ErrorContext(DbContextOptions<Sub837ErrorContext> options)
                  : base(options)
        {
        ...
        {
            modelBuilder.HasDefaultSchema("SubError");
            ...
            modelBuilder.Entity<ValidationError>().ToTable("ValidationError");
        }
