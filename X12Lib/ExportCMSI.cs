...
namespace X12Lib
{
    ...
    {
        public static string ExportCMSI(ref List<ClaimHeader> headers, ref List<ClaimCAS> cases, ref List<ClaimCRC> crcs, ref List<ClaimHI> his, ref List<ClaimK3> k3s, ref List<ClaimLineFRM> frms, ref List<ClaimLineLQ> lqs, ref List<ClaimLineMEA> meas, ref List<ClaimLineSVD> svds, ref List<ClaimNte> notes, ref List<ClaimPatient> patients, ref List<ClaimProvider> providers, ref List<ClaimPWK> pwks, ref List<ClaimSBR> sbrs, ref List<ClaimSecondaryIdentification> secondaryidentifications, ref List<ProviderContact> providercontacts, ref List<ServiceLine> servicelines, string flag)
        {
