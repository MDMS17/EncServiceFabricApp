...
IF OBJECT_ID('dbo.IpaFileLog') IS NOT NULL DROP TABLE dbo.IpaFileLog;
CREATE TABLE [dbo].[IpaFileLog](
                [Id] [int] IDENTITY(1,1) NOT NULL,
                [Kaiser_PCPA_Received] [bit] NULL,
                [Kaiser_PCPA_Error] [bit] NULL,
                [Kaiser_PCPA_Correction] [bit] NULL,
                [Kaiser_MCPD_Received] [bit] NULL,
                [Kaiser_MCPD_Error] [bit] NULL,
                [Kaiser_MCPD_Correction] [bit] NULL,
                [A_MCPD_Received] [bit] NULL,
                [A_MCPD_Error] [bit] NULL,
                [A_MCPD_Correction] [bit] NULL,
                [B_MCPD_Received] [bit] NULL,
                [B_MCPD_Error] [bit] NULL,
                [B_MCPD_Correction] [bit] NULL,
                [E_MCPD_Received] [bit] NULL,
                [E_MCPD_Error] [bit] NULL,
                [E_MCPD_Correction] [bit] NULL,
                [F_MCPD_Received] [bit] NULL,
                [F_MCPD_Error] [bit] NULL,
                [F_MCPD_Correction] [bit] NULL,
                [N_MCPD_Received] [bit] NULL,
                [N_MCPD_Error] [bit] NULL,
                [N_MCPD_Correction] [bit] NULL,
                [Y_MCPD_Received] [bit] NULL,
                [Y_MCPD_Error] [bit] NULL,
                [Y_MCPD_Correction] [bit] NULL,
                [ReportingPeriod] [varchar](6) NULL,
CONSTRAINT [PK_IpaFileLog] PRIMARY KEY CLUSTERED 
(
                [Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
