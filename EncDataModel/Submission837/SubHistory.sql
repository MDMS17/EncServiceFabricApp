CREATE SCHEMA SubHistory;
GO
CREATE TABLE [SubHistory].[ClaimCAS](
 ...
 CONSTRAINT [PK_SubHistory.ClaimCAS] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
CREATE TABLE [SubHistory].[ClaimCRCs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimCRCs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimHeaders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimHeaders] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimHIs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimHIs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimK3s](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
	[K3] [varchar](100) NULL,
 CONSTRAINT [PK_SubHistory.ClaimK3s] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimLineFRMs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimLineFRMs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimLineLQs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimLineLQs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimLineMEAs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimLineMEAs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimLineSVDs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimLineSVDs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimNtes](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimNtes] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimPatients](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimPatients] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimProviders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	...
	[RepeatSequence] [varchar](50) NULL,
 CONSTRAINT [PK_SubHistory.ClaimProviders] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimPWKs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimPWKs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimSBRs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[LoopName] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ClaimSBRs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimSecondaryIdentifications](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
	...
	[RepeatSequence] [varchar](50) NULL,
 CONSTRAINT [PK_SubHistory.ClaimSecondaryIdentifications] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ClaimTempHost](
	[ClaimID] [varchar](50) NOT NULL,
 CONSTRAINT [PK_SubHistory.ClaimID] PRIMARY KEY CLUSTERED 
(
	[ClaimID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[Hipaa_XML](
...
CREATE TABLE [SubHistory].[ProviderContacts](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ProviderContacts] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ServiceLines](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ServiceLines] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[SubmissionLogs](
 ...
 CONSTRAINT [PK_SubHistory.SubmissionLogs] PRIMARY KEY CLUSTERED 
(
	[FileID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [SubHistory].[ToothStatus](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[LoopName] [varchar](50) NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_SubHistory.ToothStatus] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
