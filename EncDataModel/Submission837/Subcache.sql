CREATE SCHEMA Subcache;
GO
CREATE TABLE [Subcache].[ClaimCAS](
 ...
 CONSTRAINT [PK_Subcache.ClaimCAS] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
CREATE TABLE [Subcache].[ClaimCRCs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimCRCs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimHeaders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimHeaders] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimHIs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimHIs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimK3s](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
	[K3] [varchar](100) NULL,
 CONSTRAINT [PK_Subcache.ClaimK3s] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimLineFRMs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimLineFRMs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimLineLQs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimLineLQs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimLineMEAs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimLineMEAs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimLineSVDs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimLineSVDs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimNtes](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimNtes] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimPatients](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimPatients] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimProviders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	...
	[RepeatSequence] [varchar](50) NULL,
 CONSTRAINT [PK_Subcache.ClaimProviders] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimPWKs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimPWKs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimSBRs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[LoopName] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ClaimSBRs] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimSecondaryIdentifications](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
	...
	[RepeatSequence] [varchar](50) NULL,
 CONSTRAINT [PK_Subcache.ClaimSecondaryIdentifications] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ClaimTempHost](
	[ClaimID] [varchar](50) NOT NULL,
 CONSTRAINT [PK_Subcache.ClaimID] PRIMARY KEY CLUSTERED 
(
	[ClaimID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[Hipaa_XML](
...
CREATE TABLE [Subcache].[ProviderContacts](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ProviderContacts] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ServiceLines](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ServiceLines] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[SubmissionLogs](
 ...
 CONSTRAINT [PK_Subcache.SubmissionLogs] PRIMARY KEY CLUSTERED 
(
	[FileID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [Subcache].[ToothStatus](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[LoopName] [varchar](50) NULL,
	[ClaimID] [varchar](50) NULL,
 ...
 CONSTRAINT [PK_Subcache.ToothStatus] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
