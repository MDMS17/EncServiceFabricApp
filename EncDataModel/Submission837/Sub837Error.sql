create schema SubError;
GO
CREATE TABLE [SubError].[ClaimCAS](
...
CREATE TABLE [SubError].[ClaimCRCs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimHeaders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimHIs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimK3s](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimLineFRMs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimLineLQs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimLineMEAs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimLineSVDs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimNtes](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimPatients](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimProviders](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
...
CREATE TABLE [SubError].[ClaimPWKs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimSBRs](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[LoopName] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimSecondaryIdentifications](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ClaimTempHost](
...
CREATE TABLE [SubError].[Hipaa_XML](
...
CREATE TABLE [SubError].[ProviderContacts](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[ServiceLines](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[ClaimID] [varchar](50) NULL,
	[ServiceLineNumber] [varchar](50) NULL,
...
CREATE TABLE [SubError].[SubmissionLogs](
...
CREATE TABLE [SubError].[ToothStatus](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[FileID] [int] NOT NULL,
	[LoopName] [varchar](50) NULL,
	[ClaimID] [varchar](50) NULL,
