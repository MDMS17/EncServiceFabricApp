...
namespace Load837Meditrac.Processes
{
    ...
    {
        public static void LoadMeditracDualI(MeditracContext _contextMeditrac, Sub837Context _context)
        {
            ...
            foreach (MeditracHeader cacheHeader in cacheHeaders)
            {
                ...
                header.ExportType = "I" + cacheHeader.GroupNumber;
            ...
            Common.ActualDualI = headers.Count;
