...
namespace Load837Meditrac.Processes
{
    ...
    {
        public static void LoadMeditracCMSP(MeditracContext _contextMeditrac, Sub837Context _context)
        {
            _contextMeditrac.Database.SetConnectionString(Common.cn_Meditrac);
            ...
            foreach (MeditracHeader cacheHeader in cacheHeaders)
            {
                ...
                if (cacheLines.Where(x => x.ClaimId == cacheHeader.ClaimId).Count(y => Common.DMEProcCodes.Contains(y.ProcedureCode)) > 0)
                {
                    ...
                    dmeHeader.ExportType = "E" + DMEHeader.GroupNumber;
