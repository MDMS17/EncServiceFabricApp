...
namespace Load837Facets.Processes
{
    ...
    {
        public static void LoadFacetsCMSP(FacetsContext _contextFacets, Sub837Context _context)
        {
            _contextFacets.Database.SetConnectionString(Common.cn_Facets);
            _context.Database.SetConnectionString(Common.cn);
            string ssss = string.Format(Common.FacetsHeader, Common.PlanId, Common.StartDate, Common.EndDate, Common.ClaimType, (Common.PageNumber * 10000).ToString());
            ...
            List<FacetsExtraSvd> CacheExtraSvds = _contextFacets.FacetsExtraSvds.FromSqlRaw(string.Format(Common.FacetsExtraSvd, Common.PlanId, Common.StartDate, Common.EndDate, Common.ClaimType, (Common.PageNumber * 10000).ToString())).ToList();
            ...
            Common.ActualCMSP = headers.Count;
